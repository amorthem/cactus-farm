...
import BscxLogo from '../../assets/img/logo.721de138.png'
  ...
  return (
    <Page>
        ...
        <div style={{fontWeight: 'bold', fontSize: 22, color: '#ffffff'}}>
            CAC Price: <span style={{color: '#F3BA2F', fontSize: 30}}>$<TotalLockValue /></span>
        </div>
        {block < launchBlock && atDate && <>
            ...
            <Spacer size="md" />
            <div>
                <ReadMore href="#" target="__blank"> 👉&nbsp;&nbsp;Read The Announcement&nbsp;&nbsp;👈</ReadMore>
            </div>
            <Spacer size="lg" />
            </>
        }
        ...
        <Box className="mt-4">
            ...
            <StyledParagraph>Earn Cactus tokens by staking CAC LP token</StyledParagraph>
            <Spacer size="lg" />
            <FarmCards />
        </Box>
    </Page>
